...
def main():
    ...
    args = ap.parse_args()
    cmd = [sys.executable, 'scripts/benchmark.py', '--json', '--N', str(args.N), '--D', str(args.D), '--kneighbors', str(args.kneighbors), '--trials', str(args.trials), '--chain-len', str(args.chain_len)]
